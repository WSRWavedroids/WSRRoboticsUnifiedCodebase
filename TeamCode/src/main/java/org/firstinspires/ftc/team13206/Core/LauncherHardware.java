...
import static org.firstinspires.ftc.team13206.Core.LauncherHardware.LauncherMode.IF_SAFE_NOW;
...
public class LauncherHardware {
    ...
    public ArtifactLocator.Slot activeFiringSlot;
